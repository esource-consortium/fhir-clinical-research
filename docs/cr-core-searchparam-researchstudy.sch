...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:SearchParameter">
      ...
      <sch:assert test="not(exists(f:xpath)) or exists(f:xpathUsage)">If an xpath is present, there SHALL be an xpathUsage (inherited)</sch:assert>
  ...
  <sch:pattern>
    <sch:title>SearchParameter.component</sch:title>
